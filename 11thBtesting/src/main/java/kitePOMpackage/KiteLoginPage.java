...
@FindBy(xpath = "//span[contains(text(),'Password should ')]") private WebElement UserPassErrorMsg;
...
public String getUserPassErrorMsg() {
	String errorMsg = UserPassErrorMsg.getText();
